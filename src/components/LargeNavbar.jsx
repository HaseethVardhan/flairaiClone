...
export const LargeNavbar = () => {
  ...
  return (
    <div
      className={`w-screen px-4 text-zinc-200 sticky top-0 lg:px-4 py-2.5 sm:py-4 z-50 flex justify-center transition-colors backdrop-blur-lg bg-[#16161678] hide-scrollbar ${
        scrolled ? "border-b border-[#ffffff1a]" : "border-b border-transparent"
      }`}
    >
      <div className="w-full max-w-6xl flex flex-row items-center justify-between">
        ...
        <div className="flex flex-row items-center">
          ...
          <h1 className="text-[1.6rem] ml-2 text-zinc-200 select-none tracking-normal font-muoto font-[200]">
            Flair.ai
          </h1>
        </div>

        {/* Center: Nav links (only visible on lg+) */}
        <nav className="hidden lg:flex flex-row gap-8 text-sm font-muoto font-semibold text-[#a1a1aa]">
          <a
            href="#features"
