...
export const Navbar = () => {
  ...
  return (
    <div className={`w-screen px-4 text-zinc-200 sticky top-0 lg:px-4 py-2.5 sm:py-4 z-50 flex flex-row items-center justify-between transition-colors backdrop-blur-lg bg-[#16161678] ${scrolled ? "border-b border-[#ffffff1a]" : "border-b border-transparent"}
      }`}>
