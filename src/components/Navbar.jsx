export const Navbar = () => {
  return (
    <div className='w-screen px-4 text-zinc-200 sticky top-0 lg:px-4 py-2.5 sm:py-4 z-50 flex flex-row items-center justify-between transition-colors border-b border-zinc-800/0'>
        <div className='flex flex-row items-center'>
            ...
            <h1 className="text-[1.6rem] ml-2 text-zinc-200 select-none tracking-normal font-muoto font-[500]">Flair.ai</h1>
        </div>
        <div>
